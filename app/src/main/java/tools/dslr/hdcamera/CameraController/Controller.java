...
/** Controller is an abstract class that wraps up the access/control to
...
public abstract class Controller {
    ...
    public Controller(int cameraId) {
    ...
    /**
     * setUseCamera2FakeFlash() should be called after creating the Controller, and before calling getCameraFeatures() or
    ...
    public abstract void reconnect() throws ControllerException;
    public abstract void setPreviewDisplay(SurfaceHolder holder) throws ControllerException;
    public abstract void setPreviewTexture(SurfaceTexture texture) throws ControllerException;
    public abstract void startPreview() throws ControllerException;
    ...
    public abstract void initVideoRecorderPostPrepare(MediaRecorder video_recorder) throws ControllerException;
