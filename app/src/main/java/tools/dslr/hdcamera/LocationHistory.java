...
public class LocationHistory {
    ...
    /** Creates a new LocationHistory class. This manages a history of save folder locations.
     * @param main_activity HomeActivity.
     * @param pref_base String to use for shared preferences.
     * @param folder_name The current save folder.
     */
    LocationHistory(HomeActivity main_activity, String pref_base, String folder_name) {
        if( Debug.LOG )
        ...
        updateFolderHistory(folder_name, false); // update_icon can be false, as updateGalleryIcon() is called later in HomeActivity.onResume()
     ...
     * HomeActivity.updateGalleryIcon().
     */
