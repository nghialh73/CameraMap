 ...
 *  - so in theory one can drop the Preview/ (and Controller/) classes
...
public interface ApplicationInterface {
    ...
    boolean useCamera2FakeFlash(); // whether to enable Controller.setUseCamera2FakeFlash() for Camera2 API
