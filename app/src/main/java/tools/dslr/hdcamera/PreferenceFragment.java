 ...
 *  communication to be via the bundle (since this replaced the HomeActivity,
...
public class PreferenceFragment extends android.preference.PreferenceFragment implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if( widths != null && heights != null ) {
            ...
            String resolution_preference_key = Keys.getResolutionPreferenceKey(cameraId);
            ...
            pref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if( newValue.equals("preference_raw_yes") ) {
                        ...
                        boolean done_raw_info = sharedPreferences.contains(Keys.getRawInfoPreferenceKey());
                        if( !done_raw_info ) {
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(PreferenceFragment.this.getActivity());
                            ...
                            alertDialog.setNegativeButton(R.string.dont_show_again, new OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    editor.putBoolean(Keys.getRawInfoPreferenceKey(), true);
                                    editor.apply();
                                }
                            });
                            alertDialog.show();
        ...
        if( video_quality != null && video_quality_string != null ) {
            ...
            lp.setEntries(entries);
            lp.setEntryValues(values);
            String video_quality_preference_key = Keys.getVideoQualityPreferenceKey(cameraId);
        ...
        }*/
        {
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    ...
                    HomeActivity main_activity = (HomeActivity)PreferenceFragment.this.getActivity();
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_using_saf") ) {
                        ...
                        if( sharedPreferences.getBoolean(Keys.getUsingSAFPreferenceKey(), false) ) {
                            if( Debug.LOG )
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_donate") ) {
            	        ...
            	        /*Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(HomeActivity.getDonateMarketLink()));
            	        try {
            	        	startActivity(browserIntent);
            	        }
                	        ...
                	        browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(HomeActivity.getDonateLink()));
            	        	startActivity(browserIntent);
            			}*/
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(HomeActivity.getDonateLink()));
                        startActivity(browserIntent);
                        return false;
                    }
                    return false;
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_about") ) {
                        ...
                        int version_code = -1;
                        try {
                            PackageInfo pInfo = PreferenceFragment.this.getActivity().getPackageManager().getPackageInfo(PreferenceFragment.this.getActivity().getPackageName(), 0);
                        ...
                        about_string.append("\nPackage: ");
                        about_string.append(PreferenceFragment.this.getActivity().getPackageName());
                        about_string.append("\nAndroid API version: ");
                        ...
                        }
                        {
                            ...
                            Display display = PreferenceFragment.this.getActivity().getWindowManager().getDefaultDisplay();
                        ...
                        about_string.append("\nAuto-stabilise enabled?: " + sharedPreferences.getBoolean(Keys.getAutoStabilisePreferenceKey(), false));
                        about_string.append("\nFace detection?: ");
                        ...
                        about_string.append("\nUsing SAF?: " + sharedPreferences.getBoolean(Keys.getUsingSAFPreferenceKey(), false));
                        String save_location = sharedPreferences.getString(Keys.getSaveLocationPreferenceKey(), "OpenCamera");
                        about_string.append("\nSave Location: " + save_location);
                        String save_location_saf = sharedPreferences.getString(Keys.getSaveLocationSAFPreferenceKey(), "");
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_reset") ) {
                        ...
                        new AlertDialog.Builder(PreferenceFragment.this.getActivity())
